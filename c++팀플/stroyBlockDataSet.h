...
public:
    Block5()
    {
        script = "한 나그네가 길에 서있다. 그 나그네는 자신의 수수께끼를 맞춰보라고 한다.\n신기한 주머니에 동전을 한개 넣으면 다음날 두개가 되고, 그다음날 4개가 된다. 이 주머니가 가득차기까지 60일이 걸렸다면,\n처음에 동전을 두개를 넣으면 이 주머니가 다 차기까지 며칠이 걸릴까?"; //스크립트 초기화
...
public:
    Block6()
    {
        script = "한 나그네가 길에 서있다. 그 나그네는 자신의 수수께끼를 맞춰보라고 한다.\n번식력이 뛰어난 생쥐가 있다. 생쥐는 한달에 한번씩 새끼를 낳으며 한번에 10마리씩 낳는다고 한다.\n또 태어난 새끼는 생후 2개월 부터 새끼를 낳는다. 지금 막 태어난 새끼 한마리를 키우기 시작했다면, 4개월 뒤에는 몇 마리가 되어있을까?"; //스크립트 초기화
